...
def process_invoice_payment(invoice_data):
	...
	try:
		...
		next_billing_date= update_next_billing_date(stripe_customer, anchor_date,billing_interval)
		stripe_customer.anchor_date = next_billing_date  # Set new anchor_date to the next billing date
